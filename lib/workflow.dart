...
export TERMUX_APP__PACKAGE_NAME=com.cateners.tiny_computer
...
class LogcatManager {
  ...
  Future<void> startCapture() async {
    ...
    try {
      ...
      final logFile = File('${logDir.path}/tiny_computer_$timestamp.log');
      ...
      sink.write('=== Tiny Computer Logcat Capture ===\n');
