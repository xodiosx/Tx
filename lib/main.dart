...
class LogcatManager {
  ...
  Future<void> startCapture() async {
    ...
    try {
      ...
      final logFile = File('${_logDir.path}/logcat_$timestamp.txt');
      ...
      _logcatProcess!.stdout.transform(utf8.decoder).listen((data) {
        sink.write(data);
      });
      
      _logcatProcess!.stderr.transform(utf8.decoder).listen((data) {
        sink.write(data);
      });
      
      print('Logcat capture started: ${logFile.path}');
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          const Text('Backup and restore system configuration and data.'),
        ...
        children: [
          ...
          Expanded(
            child: Container(
              ...
              child: const Center(
                child: Text(
                  'Mini Games Placeholder\n\nNote: Add spirited_mini_games.dart\nand mini-games assets to enable this feature.',
                  textAlign: TextAlign.center,
...
Future<void> _copyTerminalText() async {
  try {
    ...
    final selectedText = termPty.terminal.buffer.getText();
